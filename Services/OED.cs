...
namespace YADB.Services
{
    ...
    public static class OED
    {
        ...
        public static async Task<string[]> GetDefinition(string word)
        {
            ...
            //  Get lemma for word
            string lemma = await GetLemmas(word);
            ...
            //  Get web response
            JObject webResponse = await GetWebData(fullurl);
        ...
        public static async Task<string[]> GetSynonym(string word)
        {
        ...
        public static async Task<string[]> GetAntonym(string word)
        {
        ...
        /// </summary>
        private static async Task<string> GetLemmas(string word)
        {
            string lemma = word;
            ...
            JObject response = await GetWebData(fullurl);
        ...
        /// </summary>
        private static async Task<JObject> GetWebData(string fullurl)
        {
            ...
            webRequest.Headers["app_id"] = Decrypt(id, de);
            webRequest.Headers["app_key"] = Decrypt(key, de);
